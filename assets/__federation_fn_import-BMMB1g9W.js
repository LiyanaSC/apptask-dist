...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-DpcnqNqo.js', import.meta.url).href),import:true,requiredVersion:'3.5.13'},'pinia':{get:()=>()=>__federation_import(new URL('__federation_shared_pinia-D8SBplsz.js', import.meta.url).href),import:true}};
