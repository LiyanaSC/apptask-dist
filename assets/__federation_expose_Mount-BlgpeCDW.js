...
const useTaskStore = defineStore('task', () => {
    ...
    ref$8(false); // Indique si l'affichage d'un seul élément de la liste est activé
...
const {unref:_unref$3,openBlock:_openBlock$5,createElementBlock:_createElementBlock$5,createCommentVNode:_createCommentVNode$4,toDisplayString:_toDisplayString$4,createElementVNode:_createElementVNode$5,withModifiers:_withModifiers$1,normalizeClass:_normalizeClass$2} = await importShared('vue');
...
return (_ctx, _cache) => {
  return (_openBlock$5(), _createElementBlock$5("div", {
    class: _normalizeClass$2(_unref$3(taskStore).SingleView ? 'choices-box-single-view' : 'choices-box'),
    onClick: _cache[2] || (_cache[2] = $event => (updateTaskStatus()))
  }, [
    (selected.value)
    ...
    _createElementVNode$5("img", {
      ...
      class: _normalizeClass$2(_unref$3(taskStore).SingleView ? 'task-image-single-view' : 'task-image')
...
const Result = /*#__PURE__*/_export_sfc(_sfc_main$4, [['__scopeId',"data-v-ee6174a5"]]);
...
const _hoisted_6 = { class: "content-list" };
const _hoisted_7 = { key: 0 };
const _hoisted_8 = {
  key: 1,
  class: "list-items-container"
};
const _hoisted_9 = { class: "list-items" };
  ...
  return (_unref$1(isMobile) ? _unref$1(taskStore).showTasksListResults  : _unref$1(isMobile) === false)
    ? (_openBlock$2(), _createElementBlock$2("div", {
        ...
        (_unref$1(taskStore).selectedTasksList)
          ? (_openBlock$2(), _createElementBlock$2("div", {
              ...
              _createElementVNode$2("img", {
                ...
                onClick: _cache[1] || (_cache[1] = $event => (_unref$1(taskStore).SingleView = true))
              }, null, 8, _hoisted_4$1),
              _createElementVNode$2("img", {
                src: _unref$1(multiSquareDark),
                alt: "voir plusieurs éléments de la liste",
                class: "option-icon icon-right",
                onClick: _cache[2] || (_cache[2] = $event => (_unref$1(taskStore).SingleView = false))
              }, null, 8, _hoisted_5$1)
            ], 2))
          : _createCommentVNode$1("", true),
        ...
        _createElementVNode$2("div", _hoisted_6, [
          (!_unref$1(taskStore).selectedTasksList)
            ? (_openBlock$2(), _createElementBlock$2("p", _hoisted_7, _cache[5] || (_cache[5] = [
            ...
            : (_openBlock$2(), _createElementBlock$2("div", _hoisted_8, [
                _createElementVNode$2("div", _hoisted_9, [
                  ...
                  _cache[6] || (_cache[6] = _createTextVNode$1("--> "))
                ]),
                _createElementVNode$2("button", {
                  onClick: _cache[3] || (_cache[3] = $event => (_unref$1(taskStore).showTasksListSelection = true)),
                  class: "add-entry-box"
                }, [
                  _createElementVNode$2("img", {
                ...
                (_unref$1(taskStore).showTasksListSelection)
                  ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_11, [
                      ...
                      _createElementVNode$2("button", {
                        ...
                        onClick: _cache[4] || (_cache[4] = $event => (_unref$1(taskStore).showTasksListSelection = false))
                      }, "J'ai fini !")
                    ]))
                  : _createCommentVNode$1("", true)
              ]))
...
const TaskResults = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-187a1843"]]);
...
const TaskView = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-8ef72bd2"]]);
